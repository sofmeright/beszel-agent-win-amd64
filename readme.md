...
This is a clone of the [original repo](https://gitlab.prplanit.com/precisionplanit/beszel-agent-win-amd64), as such this particular page may become outdated. I do not particularly wish to automate github without being given incentive.
...
The release binaries are available for direct download [here](https://gitlab.prplanit.com/precisionplanit/beszel-agent-win-amd64/-/releases) as well.
